...
WANDB_PROJECT_NAME="pix2pix_turbo_sshr_defaultlora_msl1_perceptual"
...
cp -r my_config_pix2pix.sh inference_paired_sshr.sh train_pix2pix_turbo_sshr.sh src "$OUTPUT_DIR"
...
accelerate launch --main_process_port 28501 --config_file my_config_pix2pix.sh \
    src/train_pix2pix_turbo_sshr.py \
