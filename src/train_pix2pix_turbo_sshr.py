...
from my_utils.training_utils import parse_args_paired_training, SSHRDataset, generate_sshr_testing_data_list, generate_sshr_training_data_list, ImageTransform
...
def main(args):
    ...
    train_img_list = generate_sshr_training_data_list(data_dir="../datasets", data_list_file="../datasets/SSHR/train_7_tuples.lst")
    val_img_list = generate_sshr_testing_data_list(data_dir="../datasets", data_list_file="../datasets/SSHR/test_7_tuples.lst")
    dataset_train = SSHRDataset(img_list=train_img_list, img_transform=ImageTransform(size=256), phase="train", tokenizer=net_pix2pix.tokenizer)
    dl_train = torch.utils.data.DataLoader(dataset_train, batch_size=args.train_batch_size, shuffle=True, num_workers=args.dataloader_num_workers)
    dataset_val = SSHRDataset(img_list=val_img_list, img_transform=ImageTransform(size=256), phase="test", tokenizer=net_pix2pix.tokenizer)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.eval_freq == 1:
                        ...
                        l_pixel, l_lpips, l_perceptual, l_ssim, lpsnr = [], [], [], [], []
