...
# from peft import register_custom_module, LoraConfig
# from custom_layers import MyLinear, MyConv2d
...
class Pix2Pix_Turbo(torch.nn.Module):
    def __init__(self, pretrained_name=None, pretrained_path=None, ckpt_folder="checkpoints", lora_rank_unet=8, lora_rank_vae=4):
        ...
        if pretrained_name == "edge_to_image":
            ...
            # custom = True
            # if custom:
            #     target_modules_mapping = { nn.Linear : MyLinear, 
            #                                 # nn.Conv2d : MyConv2d 
            #                             }   # added Mahir
            ...
            # if custom:            
            #     vae_lora_config._register_custom_module(target_modules_mapping)  # added Mahir
            ...
            # if custom:
            #     unet_lora_config._register_custom_module(target_modules_mapping)  # added Mahir
